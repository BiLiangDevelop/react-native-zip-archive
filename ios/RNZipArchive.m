                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    ...
    BOOL success = [ZipArchive unzipFileAtPath:zipPath toDestination:destinationPath delegate:self];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    ...
    BOOL success = [ZipArchive createZipFileAtPath:destinationPath withContentsOfDirectory:zipPath];
